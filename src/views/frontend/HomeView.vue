            ...
            <div class="row justify-content-center my-auto">
              <div class="col-md-4 text-center d-flex flex-column align-items-center">
                ...
                <RouterLink
                  ...
                  type="button"
                  class="wow animate__animated animate__fadeInUp btn btn-lg btn-solid-main d-flex align-items-center"
                  >立即購買
        ...
        <section class="container">
          <div class="mb-5">
            <h2
              ...
              class="wow animate__animated animate__fadeInUp text-center text-main-spec"
            >
              ✦ 暢銷單品 ✦
            </h2>
          ...
          <div
            data-wow-delay=".5s"
            data-wow-duration="2s"
            class="wow animate__animated animate__fadeIn row row-cols-lg-4 row-cols-sm-2 row-cols-2"
            role="button"
          >
      ...
      <div class="container py-5">
        <section class="">
          ...
          <div
            data-wow-delay=".5s"
            data-wow-duration="2s"
            class="wow animate__animated animate__fadeIn row row-cols-lg-4 row-cols-sm-2 row-cols-2 mb-5"
            role="button"
          >
          ...
          <div class="row row-cols-sm-2 row-cols-1">
            ...
            >
              <h2
                data-wow-duration="2s"
                class="wow animate__animated animate__fadeInUp text-center text-main-light"
              >
                最佳的送禮選擇
              </h2>
              <div
        ...
        <section class="container">
          ...
          <div class="py-3 mb-5">
            <div class="row row-cols-md-2 row-cols-1 mb-4 py-4">
              <div
                class="col d-flex flex-column px-0 justify-content-center align-items-center align-items-md-start"
              >
                <h2 data-wow-duration="1s" class="wow animate__animated animate__fadeInUp">
                  光輝時刻
                </h2>
                <h2
                  data-wow-delay=".5s"
                  data-wow-duration="1s"
                  class="wow animate__animated animate__fadeInUp mb-4"
                >
                  台灣原創香氛品牌
                </h2>
                <p class="w-75">
                ...
                <RouterLink
                  ...
                  data-wow-delay="1s"
                  data-wow-duration="1s"
                  class="wow animate__animated animate__fadeIn btn btn-solid-dpgray btn-lg w-75 mb-3"
                  >關於我們</RouterLink
                >
              </div>
              <div class="col px-0">
        ...
        <section class="">
          <div class="mb-5 pb-3">
            <div class="row row-cols-md-4 row-cols-2">
              <div class="wow animate__animated animate__zoomIn col">
              ...
              <div data-wow-delay="0.5s" class="wow animate__animated animate__zoomIn col">
              ...
              <div data-wow-delay="1s" class="wow animate__animated animate__zoomIn col">
                <span class="material-icons-round fs-1 mb-3"> phone </span>
                <p class="fs-2">客服服務</p>
                <p>
                  如購買過程及收到商品有任何問題，歡迎 來電、E-mail 聯繫我們的客服，
                  我們會盡快回覆您。
                </p>
              </div>
              <div data-wow-delay="1.5s" class="wow animate__animated animate__zoomIn col">
        ...
        <section class="container">
          ...
          <div class="">
            ...
            <div
              data-wow-delay=".5s"
              data-wow-duration="2s"
              class="wow animate__animated animate__fadeIn row row-cols-md-3 row-cols-1"
              role="button"
            >
