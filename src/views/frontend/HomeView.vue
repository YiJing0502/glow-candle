      ...
      <div class="border-bottom border-1 border-dark mb-5 pb-3">
        <div class="row row-cols-md-4 row-cols-2">
          <div class="col">
            ...
            <p class="fs-2">交貨快速</p>
            <p>在商品庫存充足下，我們允諾下單三天內會出貨，如您所訂購的商品庫存不足，我們將盡快以E-mail通知您。</p>
          </div>
          <div class="col">
            <span class="material-icons-round fs-1 mb-3"> verified_user </span>
            <p class="fs-2">售後服務</p>
            <p>依照消費者保護法規定，消費者享有商品到貨七天鑑賞期之權益，但若商品如經拆封、使用，恕無法退貨。</p>
          </div>
          <div class="col">
            <span class="material-icons-round fs-1 mb-3"> phone </span>
            <p class="fs-2">客服服務</p>
            <p>如購買過程及收到商品有任何問題，歡迎 來電、E-mail 聯繫我們的客服， 我們會盡快回覆您。</p>
          </div>
          <div class="col">
            <span class="material-icons-round fs-1 mb-3"> enhanced_encryption </span>
            <p class="fs-2">免運服務</p>
            <p>我們的商品付款採用「線上信用卡」付款後出貨，運送採用「宅配到府」免運服務，讓您輕鬆購買、安心收貨。</p>
          </div>
        </div>
      </div>
    </section>
