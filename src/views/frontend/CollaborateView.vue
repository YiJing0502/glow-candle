<template>
  <div class="container message my-5 bg-main-spec container-rounded text-main-light">
    <img width="100" :src="globe" alt="" class="mb-3" />
    <h2 class="mb-3">企業採購 / 異業合作</h2>
    <p class="mb-3">
...
import globe from '../../assets/svg/globe-asia-australia.svg';
